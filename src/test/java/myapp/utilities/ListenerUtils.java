...
public class ListenerUtils implements ITestListener, IRetryAnalyzer, IAnnotationTransformer {
    ...
    public void onTestFailure(ITestResult result) {
        //System.out.println("onTestFailure : executes ONLY AFTER EACH FAILED test cases(@Test)" + result.getName()) ;
        //We want to take a screenshot after test failures
        try {
            MediaUtils.takeScreenshotOfTheEntirePage();
            //LoggerUtils.info("Test case failed... Screenshot is captured successfully...");
        } catch (IOException e) {
            //LoggerUtils.error("Test case failed... Screenshot can not be captured...");
